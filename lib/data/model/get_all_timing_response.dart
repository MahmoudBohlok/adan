class GetAllTimingsResponse {
  int? code;
  String? status;
  Data? data;

  GetAllTimingsResponse({this.code, this.status, this.data});

  GetAllTimingsResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Gregorian {
  ...
  Gregorian.fromJson(Map<String, dynamic> json) {
    ...
    weekday = json['weekday'] != null
        ? new WeekdayObj.fromJson(json['weekday'])
        : null;
    month = json['month'] != null ? new MonthObj.fromJson(json['month']) : null;
    year = json['year'];
    designation = json['designation'] != null
        ? new Designation.fromJson(json['designation'])
        : null;
...
class WeekdayObj {
  ...
  WeekdayObj.fromJson(Map<String, dynamic> json) {
    en = json['en'];
  }
